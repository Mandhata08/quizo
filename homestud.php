...
<body style="color: #fff !important;font-weight:bolder;margin: 0 !important;font-weight: bolder !important;font-family: 'Roboto', sans-serif;">
    <div style="background-color: #042A38;height:auto;">
        ...
        <section style="margin-left: 3rem;height:3rem;display:grid;padding-top: 8px;padding-bottom: 3px; font-size: 1.5rem;font-family: 'Libre Baskerville', serif;">quizo</section>
        ...
        ?>
        <center><section style="width:100vw;height:20rem;margin:0vw;margin-top:23rem;font-size:3vw;">Welcome to quizo&nbsp;<?php echo $dbname ?></section></center>
    ...
    <footer class="footer" style= "background: black; opacity: 0.9;  font-size: 1rem; height: 3.5rem;display:flex;">
        <div class="footer_copyright" style=" text-align: center;position:absolute; margin-left:42rem; color:white;" >
             <p style="padding-top: 0.01rem;">Copyright &copy; quizo 23</p>
        </div>
    </footer>
</body>
<?php
...
"function dash(){".
    ...
    "}".
"function lo(){".
"alert(\"Thank You for Using our quizo\");";
//session_unset();
//session_destroy();
